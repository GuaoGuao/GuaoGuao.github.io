...
* 新增
    ...
    * mysql 数据结构如下
        ```
            ...
            `installedversion` varchar(20) DEFAULT NULL,
            `fixedversion` varchar(20) DEFAULT NULL,
            `digest` varchar(50) DEFAULT NULL,
            `diffid` varchar(50) DEFAULT NULL,
            `SeveritySource` varchar(50) DEFAULT NULL,
            PRIMARY KEY (`scanid`,`vulnerabilityid`) USING BTREE
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
